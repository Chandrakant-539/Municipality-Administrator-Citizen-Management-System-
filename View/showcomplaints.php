        ...
        <?php if($_SESSION['user_type']==1){ echo"<h5>My Complaints</h5>";
            ...
            <tr>
                ...
                foreach ($data as $complaint){
                    $tabledata.="<tr>
                        <td>".(isset($complaint['complaintid']) ? $complaint['complaintid'] : '')."</td>
                        <td>".(isset($complaint['subject']) ? $complaint['subject'] : '')."</td>
...
$tabledata .= "<tr>
                        <td>" . (isset($complaint['complaintid']) ? $complaint['complaintid'] : '') . "</td>
                        <td><a href='profile.php?id=" . (isset($complaint['citizen_id']) ? $complaint['citizen_id'] : '') . "&type=citizen'>" . (isset($complaint['name']) ? $complaint['name'] : '') . " " . (isset($complaint['surname']) ? $complaint['surname'] : '') . "</a></td>
                        <td>" . (isset($complaint['subject']) ? $complaint['subject'] : '') . "</td>
                        <td>" . (isset($complaint['description']) ? $complaint['description'] : '') . "</td>
                        <td>" . date("F j, Y, g:i a", strtotime($complaint['date'])) . "</td></tr>";
                }
